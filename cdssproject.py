...
Original file is located at
    https://colab.research.google.com/drive/1j-2hbmj7X_EDityf9-Fn2ZAq7_IA3IvS
"""

#R197223E Lynn N Musabayane
#R175374Q Tafadzwa Nhumburudzi
...
#as we can see there are no diseases having the same percentage through bar chart
...
joblib.dump(dt,'My_Clinical_Decision_Support_System_Model')

['My_Clinical_Decision_Support_System_Model']
a = list(range(2,134))
i_name  = (input('Enter your name :'))
i_age = (int(input('Enter your age:')))
for i in range(len(x.columns)):
    print(str(i+1+1) + ":", x.columns[i])
choices = input('Enter the Serial numbers in which your symptoms exist:  ')
...
pickle.dump(My_Clinical_Decision_Support_System_Model, open(filename, 'wb'))
#load the pickle file in read mode
